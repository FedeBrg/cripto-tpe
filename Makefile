...
lag: lagrange/lagrange.c
	gcc -c -Wall -Werror -o lagrange/lagrange.o lagrange/lagrange.c

bmp: manejo_bmp/bmp_handling.c
	gcc -c -Wall -Werror -o manejo_bmp/bmp_handling.o manejo_bmp/bmp_handling.c

dec: decrypt/decrypt.c
	gcc -c -Wall -Werror -o decrypt/decrypt.o decrypt/decrypt.c

enc: encrypt/encrypt.c
	gcc -c -Wall -Werror -o encrypt/encrypt.o encrypt/encrypt.c
